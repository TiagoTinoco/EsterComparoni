let veilsListDiv = document.getElementsByClassName('list');
console.log(veilsListDiv);

function fillList(){
    VEILS.forEach(veilObject => {
        let veilCardHTML = 
        `<a class="list-item" href="#img">
            <div onclick="onSelectVeil(${veilObject.id})" class="thickness">
